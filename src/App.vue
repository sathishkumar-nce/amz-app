  ...
  const sections = [
    {
      ...
      items: [
        ...
        { to: '/extract-return-initiated', label: 'Extract Returns' },
        { to: '/returned', label: 'Returned' },
        { to: '/fresh-roll-issues', label: 'Fresh Roll Issues' },
        { to: '/other-issues', label: 'Other Issues' },
        { to: '/safety-claims', label: 'Safety Claims' },
        { to: '/review-requests', label: 'Review Requests' },
    ...
    },
    {
      ...
      items: [
        ...
        { to: '/review-followup-settings', label: 'Review Follow-Up Settings' },
